...
Ansible позволяет описать нужное состояние системы (что должно быть установлено и как настроено), а затем автоматически привести серверы к этому состоянию.
